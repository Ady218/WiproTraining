...
def test_simple_js_alert(driver):
    ...
    assert result == "You successfully clicked an alert", "Result text was wrong"
...
def test_js_confirmdismiss(driver):
    ...
    time.sleep(3)
    result = driver.find_element(By.ID, "result").text
    assert result == "You clicked: Cancel", "Result text was wrong"
...
def test_js_confirmok(driver):
    ...
    time.sleep(3)
    result = driver.find_element(By.ID, "result").text
    assert result == "You clicked: Ok", "Result text was wrong"
...
def test_js_prompt(driver):
    ...
    time.sleep(3)
    result = driver.find_element(By.ID, "result").text
    assert result == "You entered: Python Selenium", "Result text was wrong"